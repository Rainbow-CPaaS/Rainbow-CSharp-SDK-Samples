...
namespace BotAdaptiveCards
{
    ...
    public class Util
    {
        ...
        static internal Stream? GetStreamFromEmbeddedResource(String resourceName)
        {
            ...
            Stream? streamResourceInfo = typeof(BotAdaptiveCards.Util).Assembly.GetManifestResourceStream(resourcePath);
        ...
        static internal void InitResourcesList()
        {
            if (resources == null && !resourcesInit)
            {
                ...
                String[] rsc = typeof(BotAdaptiveCards.Util).Assembly.GetManifestResourceNames();
