...
namespace BotVideoOrchestratorAndRemoteControl
{
    ...
    public class Util
    {
        internal static readonly String NamespaceResources = "BotVideoOrchestratorAndRemoteControl.Resources";
        ...
        static internal String? GetContentOfEmbeddedResource(String resourceName, Encoding? encoding = null)
        {
            String? result = null;
        ...
        static internal Stream? GetStreamFromEmbeddedResource(String resourceName)
        {
            ...
            Stream? streamResourceInfo = typeof(BotVideoOrchestratorAndRemoteControl.Util).Assembly.GetManifestResourceStream(resourcePath);
        ...
        static internal void InitResourcesList()
        {
            if (resources == null && !resourcesInit)
            {
                ...
                String[] rsc = typeof(BotVideoOrchestratorAndRemoteControl.Util).Assembly.GetManifestResourceNames();
