...
namespace BotVideoBroadcaster
{
    ...
    public class Util
    {
        internal static readonly String NamespaceResources = "BotVideoBroadcaster.Resources";
        ...
        static internal Stream? GetStreamFromEmbeddedResource(String resourceName)
        {
            ...
            Stream? streamResourceInfo = typeof(BotVideoBroadcaster.Util).Assembly.GetManifestResourceStream(resourcePath);
        ...
        static internal void InitResourcesList()
        {
            if (resources == null && !resourcesInit)
            {
                ...
                String[] rsc = typeof(BotVideoBroadcaster.Util).Assembly.GetManifestResourceNames();
