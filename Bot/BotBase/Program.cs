...
namespace RainbowBotBase
{
    internal class Program
    {
        static void Main()
        {
            ...
            // Create a Bot
            var rainbowBotBase = new RainbowBotBase();
                    ...
                    ))
            {
                ...
                if (rainbowBotBase.StartLogin())
                {
                    ...
                    RainbowBotBase.Trigger trigger;
                    RainbowBotBase.State state;
                    ...
                    while (canContinue)
                    {
                        ...
                        if (state == RainbowBotBase.State.NotConnected)
                        {
                            switch (trigger)
                            {
                                case RainbowBotBase.Trigger.Disconnect:
                                ...
                                case RainbowBotBase.Trigger.ServerNotReachable:
                                ...
                                case RainbowBotBase.Trigger.TooManyAttempts:
                        ...
                        else if (state == RainbowBotBase.State.Created)
                        {
