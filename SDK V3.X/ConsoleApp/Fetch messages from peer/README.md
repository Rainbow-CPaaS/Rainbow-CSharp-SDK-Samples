...
# Rainbow CSharp SDK v3 - Fetch messages from Peer
...
## Features
- After the login steps, the code permits search a Contact or a Bubble (as Peer)
- Once the first Peer is found, automatically this example will fetch all messages exchanged with this Peer.
- Once finished, a global view of them is stored in a file.
