...
# Rainbow CSharp SDK v3 - Get basic info
...
## Features
- After the login steps, the code permits to understand how to get/display info about contacts, bubbles and bubbles members
