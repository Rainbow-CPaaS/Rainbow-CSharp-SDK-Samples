...
# Rainbow CSharp SDK v3 - Get and Set Presence
...
## Features
- After the login steps, the code permits to understand how to get **Presence** and **Aggregated Presence** of contacts in the roster
- It's also posible to update its presence
