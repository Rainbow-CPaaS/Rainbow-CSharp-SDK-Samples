...
namespace BotAdaptiveCards
{
    ...
    public class Helper
    {
        internal static readonly String NamespaceResources = "BotAdaptiveCards.Resources";
        ...
        static internal Stream? GetStreamFromEmbeddedResource(String resourceName)
        {
            ...
            Stream? streamResourceInfo = typeof(BotAdaptiveCards.Helper).Assembly.GetManifestResourceStream(resourcePath);
        ...
        static internal void InitResourcesList()
        {
            if (!resourcesInit)
            {
                ...
                String[] rsc = typeof(BotAdaptiveCards.Helper).Assembly.GetManifestResourceNames();
