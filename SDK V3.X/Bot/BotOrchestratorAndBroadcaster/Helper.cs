...
namespace BotOrchestratorAndBroadcaster
{
    ...
    public class Helper
    {
        internal static readonly String NamespaceResources = "BotOrchestratorAndBroadcaster.Resources";
        ...
        static internal Stream? GetStreamFromEmbeddedResource(String resourceName)
        {
            ...
            Stream? streamResourceInfo = typeof(BotOrchestratorAndBroadcaster).Assembly.GetManifestResourceStream(resourcePath);
        ...
        static internal void InitResourcesList()
        {
            if (!resourcesInit)
            {
                ...
                String[] rsc = typeof(BotOrchestratorAndBroadcaster).Assembly.GetManifestResourceNames();
