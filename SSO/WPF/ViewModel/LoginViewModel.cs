...
namespace WpfSSOSamples.ViewModel
{
    ...
    #region PRIVATE METHODS
        private void Init()
        {
            ...
            Model.Login = CurrentApplication.RbApplication.GetUserLoginFromCache();
            Model.Password = CurrentApplication.RbApplication.GetUserPasswordFromCache();
    ...
    #region Events fired by Rainbow SDK
        private void RbApplication_InitializationPerformed(object sender, EventArgs e)
        {
            ...
            SetErrorMessage($"User well connected:{currentContact.DisplayName}");
        }
