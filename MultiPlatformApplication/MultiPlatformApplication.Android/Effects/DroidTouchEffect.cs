...
{
    public class DroidTouchEffect : Xamarin.Forms.Platform.Android.PlatformEffect
    {
        ...
        static Dictionary<Android.Views.View, DroidTouchEffect> viewDictionary = new Dictionary<Android.Views.View, DroidTouchEffect>();

        static Dictionary<int, DroidTouchEffect> idToEffectDictionary = new Dictionary<int, DroidTouchEffect>();
