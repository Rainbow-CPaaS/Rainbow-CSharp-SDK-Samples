    ...
    #region EVENTS RAISED BY Forms Elements
        ...
        private void btnConnect_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                rbApplication.Restrictions.UseAPIConferenceV2 = cbUseConfV2.Checked;
        ...
        {
            if ( (conferenceForm == null) || (conferenceForm?.IsDisposed == true) )
            {
                conferenceForm = new ConferenceForm();
                conferenceForm.SetApplication(rbApplication);
            }

            if(!conferenceForm.Visible)
                conferenceForm.Show(this);
        }
